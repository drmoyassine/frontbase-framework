...
//    (rollback ALL — 4 migrations: v1 schema, v2 users, v3 tenants, v4 phase2)
await migrateDown(a, 4);
...
check('applied versions recorded ascending', JSON.stringify(await appliedVersions(a)) === JSON.stringify([1, 2, 3, 4]));

...
//    (rollback ALL — 7 migrations: v1 schema, v2 users, v3 tenants, v4 phase2, v5 phase3b,
//     v6 execution_input, v7 template_variables [CF-22 P1])
await migrateDown(a, 7);
...
check('applied versions recorded ascending', JSON.stringify(await appliedVersions(a)) === JSON.stringify([1, 2, 3, 4, 5, 6, 7]));

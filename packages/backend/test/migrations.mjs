...
//    (rollback ALL — 6 migrations: v1 schema, v2 users, v3 tenants, v4 phase2, v5 phase3b, v6 execution_input)
await migrateDown(a, 6);
...
check('applied versions recorded ascending', JSON.stringify(await appliedVersions(a)) === JSON.stringify([1, 2, 3, 4, 5, 6]));

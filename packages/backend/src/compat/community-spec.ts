...
const SPEC: Record<string, unknown> = {
  "components": {
    "schemas": {
      ...
      "DatasourceCreate": {
        "description": "Schema for creating a datasource.",
        "properties": {
          "anon_key": {
            "anyOf": [
              {
      ...
      "DatasourceResponse": {
        "description": "Schema for datasource response.",
        "properties": {
          "api_url": {
            "anyOf": [
              {
          ...
          "views": {
            "items": {
              "$ref": "#/components/schemas/DatasourceViewResponse"
            },
            "title": "Views",
            "type": "array"
          }
      ...
      "DatasourceTestRequest": {
        "description": "Schema for testing a new datasource connection.",
        "properties": {
          "anon_key": {
            "anyOf": [
              {
      ...
      "DatasourceTestResult": {
        "description": "Schema for connection test result.",
        "properties": {
          "error": {
            "anyOf": [
              {
      ...
      "DatasourceUpdate": {
        "description": "Schema for updating a datasource.",
        "properties": {
          "anon_key": {
            "anyOf": [
              {
      ...
      "DatasourceViewCreate": {
        "description": "Schema for creating a datasource view.",
        "properties": {
          "column_order": {
            "items": {
              "type": "string"
        ...
        "title": "DatasourceViewCreate",
        "type": "object"
      },
      "DatasourceViewResponse": {
        "description": "Schema for datasource view response.",
        "properties": {
          "column_order": {
            "items": {
              "type": "string"
        ...
        "title": "DatasourceViewResponse",
        "type": "object"
      },
      "DatasourceViewUpdate": {
        "description": "Schema for updating a datasource view.",
        "properties": {
          "column_order": {
            "anyOf": [
              {
      ...
      "DistinctValuesResponse": {
        "additionalProperties": true,
        "description": "GET /{datasource_id}/tables/{table}/distinct/{column}/.",
        "properties": {
          "data": {
            "default": [],
            "items": {},
      ...
      "MigrationApplyResponse": {
        ...
        "title": "MigrationApplyResponse",
        "type": "object"
      },
      "MigrationCheckResponse": {
        "additionalProperties": true,
        "description": "GET check-migration \u2014 `applicable` False for non-Supabase datasources.",
        "properties": {
          "applicable": {
            "title": "Applicable",
            "type": "boolean"
      ...
      "RecordMutationResponse": {
        "additionalProperties": true,
        "description": "POST/PATCH a single record \u2014 echoes the affected row.",
        "properties": {
          "record": {
            "anyOf": [
              {
      ...
      "RedisSettingsResponse": {
        "description": "Schema for Redis settings response.",
        "properties": {
          "cache_ttl_count": {
            "default": 300,
            "title": "Cache Ttl Count",
        ...
        "title": "RedisSettingsResponse",
        "type": "object"
      },
      "RedisSettingsUpdate": {
        "description": "Schema for updating Redis settings.",
        "properties": {
          "cache_ttl_count": {
            "default": 300,
            "title": "Cache Ttl Count",
      ...
      "RelationshipDefinition": {
        "description": "A manually-defined FK relationship.",
        "properties": {
          "cascade_delete": {
            "default": false,
            "description": "Delete related rows when source is deleted (future)",
          ...
          "display_column": {
            ...
            "description": "Column in the parent (to_table) whose value to display for this FK (e.g. show a school's name instead of its id). When set, the table data endpoint returns a lookup map for this FK column.",
            "title": "Display Column"
          },
          "from_column": {
            "description": "Source column (the FK)",
            "minLength": 1,
            "title": "From Column",
            "type": "string"
          },
          "from_table": {
            "description": "Source table (holds the FK column)",
            "minLength": 1,
            "title": "From Table",
            "type": "string"
          },
          ...
          "to_column": {
            "description": "Target column (the referenced PK/column)",
            "minLength": 1,
            "title": "To Column",
            "type": "string"
          },
          "to_table": {
            "description": "Target table (the referenced table)",
            "minLength": 1,
            "title": "To Table",
            "type": "string"
          }
      ...
      "RelationshipRemovedResponse": {
        ...
        "title": "RelationshipRemovedResponse",
        "type": "object"
      },
      "RelationshipResponse": {
        "description": "Relationship echoed back after create/update, with its array index.",
        "properties": {
          "index": {
            "title": "Index",
            "type": "integer"
      ...
      "SearchAllResponse": {
        "additionalProperties": true,
        "description": "GET /search-all/ \u2014 matches across every datasource.",
        "properties": {
          "matches": {
            "default": [],
            "items": {
      ...
      "SheetsConnectCallback": {
        "properties": {
          ...
          "spreadsheetName": {
            ...
            "description": "Human-readable sheet name",
            "title": "Spreadsheetname"
          },
          "token": {
            "description": "Connect token from /issue",
            "maxLength": 128,
            "minLength": 10,
            "title": "Token",
            "type": "string"
          ...
          "webAppSecret": {
            "description": "Shared secret for Web App",
            "maxLength": 256,
            "minLength": 8,
            "title": "Webappsecret",
            "type": "string"
          ...
          "webAppUrl": {
            "description": "Apps Script Web App exec URL",
            "maxLength": 1000,
            "minLength": 10,
            "title": "Webappurl",
            "type": "string"
        ...
        "title": "SheetsConnectCallback",
        "type": "object"
      },
      "SheetsConnectIssueRequest": {
        "description": "Optional reconnect target. If omitted, a new datasource is created.",
        "properties": {
          "datasource_id": {
            "anyOf": [
              {
        ...
        "title": "SheetsConnectIssueRequest",
        "type": "object"
      },
      "SheetsConnectIssueResponse": {
        "properties": {
          "addonInstallUrl": {
            "title": "Addoninstallurl",
            "type": "string"
          },
          "expiresAt": {
            "format": "date-time",
        ...
        "title": "SheetsConnectIssueResponse",
        "type": "object"
      },
      "SheetsConnectResult": {
        "properties": {
      ...
      "SyncHealthResponse": {
        ...
        "title": "SyncHealthResponse",
        "type": "object"
      },
      "SyncRedisTestResult": {
        "description": "Schema for Redis connection test result.",
        "properties": {
          "message": {
            "title": "Message",
            "type": "string"
      ...
      "TableAggregateResponse": {
        "additionalProperties": true,
        "description": "GET /{datasource_id}/tables/{table}/aggregate/ \u2014 caller-chosen aggregates.",
        "properties": {
          "data": {
            "title": "Data"
          },
      ...
      "TableDataResponse": {
        "additionalProperties": true,
        "description": "GET /{datasource_id}/tables/{table}/data/ \u2014 a page of rows.",
        "properties": {
          "fk_columns": {
            "additionalProperties": true,
            "default": {},
      ...
      "TableSchema": {
        "description": "Schema for a table/resource.",
        "properties": {
          "columns": {
            "items": {
      ...
      "TableSearchResponse": {
        "additionalProperties": true,
        "description": "GET /{datasource_id}/search \u2014 per-table match counts.",
        "properties": {
          "matches": {
            "default": [],
            "items": {
      ...
      "TableSessionClearedResponse": {
        ...
        "title": "TableSessionClearedResponse",
        "type": "object"
      },
      "TableSessionResponse": {
        "additionalProperties": true,
        "description": "GET session \u2014 an arbitrary persisted editor session blob (may be empty).",
        "properties": {},
      ...
      "TableSessionSaveResponse": {
        "additionalProperties": true,
        "description": "POST session \u2014 `persisted` is False when Redis is unavailable.",
        "properties": {
          "message": {
            "anyOf": [
              {
        ...
        "title": "TableSessionSaveResponse",
        "type": "object"
      },
      "TablesData": {
        "properties": {
      ...
      "UserRelationshipsResponse": {
        ...
        "title": "UserRelationshipsResponse",
        "type": "object"
      },
      "UserResponse": {
        "properties": {
      ...
      "ViewRecordMutationResponse": {
        ...
        "title": "ViewRecordMutationResponse",
        "type": "object"
      },
      "ViewRecordsResponse": {
        "additionalProperties": true,
        "description": "GET /views/{view_id}/records/ \u2014 a page of rows plus view metadata.",
        "properties": {
          "current_page": {
            "title": "Current Page",
            "type": "integer"
      ...
      "WordPressImportRequest": {
        "description": "Body for POST /import/.",
        "properties": {
          "datasource_id": {
            "title": "Datasource Id",
            "type": "string"
  ...
  "paths": {
    ...
    "/api/sync/datasources/": {
      "get": {
        "description": "List all registered datasources.",
        "operationId": "list_datasources_datasources__get",
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "title": "Response List Datasources Datasources  Get",
                  "type": "array"
                }
              }
            },
      ...
      "post": {
        ...
        "operationId": "create_datasource_datasources__post",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
    ...
    "/api/sync/datasources/search-all/": {
      "get": {
        "description": "Search for a string across all tables in ALL datasources.",
        "operationId": "search_all_datasources_datasources_search_all__get",
        "parameters": [
          {
            "in": "query",
            "name": "q",
      ...
      "post": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/SheetsConnectCallback"
              }
            }
          },
          "required": true
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/SheetsConnectResult"
                }
              }
            },
            "description": "Successful Response"
    ...
    "/api/sync/datasources/sheets/connect/issue/": {
      "post": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "anyOf": [
                  {
                    "$ref": "#/components/schemas/SheetsConnectIssueRequest"
                  },
                  {
                    "type": "null"
                  }
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/SheetsConnectIssueResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Sheets Connect Issue",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/sheets/connect/status/": {
      "get": {
        "description": "Polled by the modal until the add-on callback completes the connection.\n\nPhase 2: Returns accountId (Connected Account) instead of datasourceId.",
        "operationId": "sheets_connect_status_datasources_sheets_connect_status__get",
        "parameters": [
          {
            "in": "query",
            "name": "token",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/SheetsConnectStatus"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Sheets Connect Status",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/test-raw/": {
      "post": {
        "description": "Test a new datasource connection with raw credentials without saving.",
        "operationId": "test_new_datasource_datasources_test_raw__post",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
    ...
    "/api/sync/datasources/{datasource_id}/": {
      "delete": {
        "description": "Delete a datasource.",
        "operationId": "delete_datasource_datasources__datasource_id___delete",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
      ...
      "get": {
        ...
        "operationId": "get_datasource_datasources__datasource_id___get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
      ...
      "put": {
        ...
        "operationId": "update_datasource_datasources__datasource_id___put",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
    ...
    "/api/sync/datasources/{datasource_id}/apply-migration": {
      "post": {
        "description": "Apply Frontbase migration SQL to a Supabase datasource.\nCreates required RPC functions for schema introspection, user management, etc.",
        "operationId": "apply_datasource_migration_datasources__datasource_id__apply_migration_post",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
        ...
        "summary": "Apply Datasource Migration",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/check-migration": {
      "get": {
        "description": "Check if Frontbase migration has been applied to a Supabase datasource.\nReturns status of required RPC functions.",
        "operationId": "check_datasource_migration_datasources__datasource_id__check_migration_get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/MigrationCheckResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Check Datasource Migration",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/relationships/": {
      "get": {
        "description": "Get all foreign key relationships for all tables in a datasource.\n\nUses cached schemas from SQLite (single source of truth).\nUse ?refresh=true to re-discover from external datasource.",
        "operationId": "get_datasource_relationships_datasources__datasource_id__relationships__get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
        ...
        "summary": "Get Datasource Relationships",
        "tags": [
          "Datasources"
        ]
      },
      "post": {
        "description": "Add a user-defined relationship to the datasource (stored in extra_config).",
        "operationId": "create_user_relationship_datasources__datasource_id__relationships__post",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
    ...
    "/api/sync/datasources/{datasource_id}/relationships/user-defined/": {
      "get": {
        "description": "List only the user-defined relationships (raw, with index).",
        "operationId": "list_user_relationships_datasources__datasource_id__relationships_user_defined__get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
    ...
    "/api/sync/datasources/{datasource_id}/relationships/{index}/": {
      "delete": {
        "description": "Remove the user-defined relationship at `index`.",
        "operationId": "remove_relationship_datasources__datasource_id__relationships__index___delete",
        "parameters": [
          {
            "in": "path",
            "name": "index",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/RelationshipRemovedResponse"
                }
              }
            },
            "description": "Successful Response"
      ...
      "put": {
        "description": "Replace the user-defined relationship at `index`.",
        "operationId": "update_relationship_datasources__datasource_id__relationships__index___put",
        "parameters": [
          {
            "in": "path",
            "name": "index",
    ...
    "/api/sync/datasources/{datasource_id}/search": {
      "get": {
        "description": "Search for a string across all tables in a specific datasource.",
        "operationId": "search_datasource_tables_datasources__datasource_id__search_get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
        ...
        "summary": "Search Datasource Tables",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/tables/": {
      "get": {
        "description": "Get list of tables/resources from a datasource.",
        "operationId": "get_datasource_tables_datasources__datasource_id__tables__get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
            ...
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "title": "Response Get Datasource Tables Datasources  Datasource Id  Tables  Get",
                  "type": "array"
                }
              }
            },
    ...
    "/api/sync/datasources/{datasource_id}/tables/{table_name}/session/": {
      "delete": {
        "description": "Clear draft layout/config from Redis session.",
        "operationId": "clear_table_session_datasources__datasource_id__tables__table_name__session__delete",
        "parameters": [
          {
            "in": "path",
            "name": "table_name",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/TableSessionClearedResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Clear Table Session",
        "tags": [
          "Datasources"
        ]
      },
      "get": {
        "description": "Retrieve draft layout/config from Redis session.",
        "operationId": "get_table_session_datasources__datasource_id__tables__table_name__session__get",
        "parameters": [
          {
            "in": "path",
            "name": "table_name",
        ...
        "summary": "Get Table Session",
        "tags": [
          "Datasources"
        ]
      },
      "post": {
        "description": "Save draft layout/config to Redis session (optional - gracefully degrades if Redis unavailable).",
        "operationId": "save_table_session_datasources__datasource_id__tables__table_name__session__post",
        "parameters": [
          {
            "in": "path",
            "name": "table_name",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/TableSessionSaveResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Save Table Session",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/tables/{table}/aggregate/": {
      "get": {
        "description": "Group a table by `category` and aggregate a measure per group for charts.\n\nAggregation happens in the database (GROUP BY) so counts/sums are correct for\nthe whole table, not a fetched page. Returns rows shaped {category, value}.",
        "operationId": "get_datasource_table_aggregate_datasources__datasource_id__tables__table__aggregate__get",
        "parameters": [
          {
            "in": "path",
            "name": "table",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/TableAggregateResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Get Datasource Table Aggregate",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/tables/{table}/data/": {
      "get": {
        "description": "Get data for a specific table in a datasource with pagination, sorting, search, and related data.",
        "operationId": "get_datasource_table_data_datasources__datasource_id__tables__table__data__get",
        "parameters": [
          {
            "in": "path",
            "name": "table",
        ...
        "summary": "Get Datasource Table Data",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/tables/{table}/distinct/{column}/": {
      "get": {
        "description": "Get distinct values for a column (for dropdown filter options).",
        "operationId": "get_distinct_values_datasources__datasource_id__tables__table__distinct__column___get",
        "parameters": [
          {
            "in": "path",
            "name": "table",
    ...
    "/api/sync/datasources/{datasource_id}/tables/{table}/records/": {
      "post": {
        "description": "Create a new record in a table.",
        "operationId": "create_record_datasources__datasource_id__tables__table__records__post",
        "parameters": [
          {
            "in": "path",
            "name": "table",
    ...
    "/api/sync/datasources/{datasource_id}/tables/{table}/records/{record_id}": {
      "patch": {
        "description": "Update an existing record in a table.",
        "operationId": "update_record_datasources__datasource_id__tables__table__records__record_id__patch",
        "parameters": [
          {
            "in": "path",
            "name": "table",
    ...
    "/api/sync/datasources/{datasource_id}/tables/{table}/schema/": {
      "get": {
        "description": "Get schema for a specific table in a datasource.\n\nSchema is cached in SQLite for instant subsequent loads.\nUse ?refresh=true to force a fresh fetch from the source.",
        "operationId": "get_table_schema_datasources__datasource_id__tables__table__schema__get",
        "parameters": [
          {
            "in": "path",
            "name": "table",
    ...
    "/api/sync/datasources/{datasource_id}/test-update/": {
      "post": {
        "description": "Test a datasource connection with proposed updates merged into existing config.",
        "operationId": "test_datasource_update_datasources__datasource_id__test_update__post",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
        ...
        "summary": "Test Datasource Update",
        "tags": [
          "Datasources"
        ]
      }
    },
    "/api/sync/datasources/{datasource_id}/test/": {
      "post": {
        "description": "Test a datasource connection.",
        "operationId": "test_datasource_datasources__datasource_id__test__post",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
    ...
    "/api/sync/datasources/{datasource_id}/views/": {
      "get": {
        "description": "List all views for a specific datasource.",
        "operationId": "list_datasource_views_datasources__datasource_id__views__get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
            ...
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "title": "Response List Datasource Views Datasources  Datasource Id  Views  Get",
                  "type": "array"
                }
              }
            },
        ...
        "summary": "List Datasource Views",
        "tags": [
          "Datasources"
        ]
      },
      "post": {
        "description": "Create a new view for a datasource.",
        "operationId": "create_datasource_view_datasources__datasource_id__views__post",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/DatasourceViewCreate"
              }
            }
          },
          "required": true
    ...
    "/api/sync/datasources/{datasource_id}/wordpress/discover/": {
      "get": {
        "description": "Return the full WordPress discovery manifest for a plugin datasource.\n\nRequires the datasource ``type`` to be ``wordpress_plugin``. The adapter\ncaches the manifest (Redis + in-process) for ~5 minutes.",
        "operationId": "get_wordpress_discovery_datasources__datasource_id__wordpress_discover__get",
        "parameters": [
          {
            "in": "path",
            "name": "datasource_id",
          ...
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "additionalProperties": true,
                  "title": "Response Get Wordpress Discovery Datasources  Datasource Id  Wordpress Discover  Get",
                  "type": "object"
                }
              }
            },
    ...
    "/api/sync/settings/redis/": {
      "get": {
        "description": "Get current Redis settings \u2014 delegates to main app's settings.json.",
        "operationId": "get_redis_settings_settings_redis__get",
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/RedisSettingsResponse"
                }
              }
            },
            "description": "Successful Response"
      ...
      "put": {
        ...
        "operationId": "update_redis_settings_settings_redis__put",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/RedisSettingsUpdate"
              }
            }
          },
          "required": true
    ...
    "/api/sync/settings/redis/test/": {
      "post": {
        "description": "Test Redis connection with provided URL and token.",
        "operationId": "test_redis_settings_redis_test__post",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/SyncRedisTestResult"
                }
              }
            },
            "description": "Successful Response"
    ...
    "/api/sync/views/{view_id}/": {
      "delete": {
        "description": "Delete a datasource view.",
        "operationId": "delete_datasource_view_views__view_id___delete",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
        ...
        "summary": "Delete Datasource View",
        "tags": [
          "Views"
        ]
      },
      "get": {
        "description": "Get a specific datasource view.",
        "operationId": "get_datasource_view_views__view_id___get",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
        ...
        "summary": "Get Datasource View",
        "tags": [
          "Views"
        ]
      },
      "patch": {
        "description": "Update an existing datasource view.",
        "operationId": "update_datasource_view_views__view_id___patch",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/DatasourceViewUpdate"
              }
            }
          },
          "required": true
        ...
        "summary": "Update Datasource View",
        "tags": [
          "Views"
        ]
      }
    },
    "/api/sync/views/{view_id}/count": {
      "get": {
        "description": "Get the total number of records matching a view's filters.\n\nThis is a lightweight endpoint that only returns the count,\nuseful for displaying totals without fetching all data.",
        "operationId": "get_view_count_views__view_id__count_get",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
    ...
    "/api/sync/views/{view_id}/records": {
      "patch": {
        "description": "Partially update an existing record in the table associated with this view.",
        "operationId": "patch_view_record_views__view_id__records_patch",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ViewRecordMutationResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Patch View Record",
        "tags": [
          "Views"
        ]
      },
      "post": {
        "description": "Create a new record in the table associated with this view.",
        "operationId": "create_view_record_views__view_id__records_post",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
    ...
    "/api/sync/views/{view_id}/records/": {
      "get": {
        "description": "Get data matching the view's filters with pagination.\n\n- **page**: Page number (1-indexed, default 1)\n- **limit**: Records per page (default 10)\n\nReturns paginated records with total count and page info.",
        "operationId": "get_view_records_views__view_id__records__get",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ViewRecordsResponse"
                }
              }
            },
            "description": "Successful Response"
    ...
    "/api/sync/views/{view_id}/trigger/": {
      "post": {
        "description": "Manually trigger the view logic and forward to registered webhooks.\nCan be used by external sources to route data through db-synchronizer.",
        "operationId": "trigger_view_webhook_views__view_id__trigger__post",
        "parameters": [
          {
            "in": "path",
            "name": "view_id",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ViewTriggerResponse"
                }
              }
            },
            "description": "Successful Response"
        ...
        "summary": "Trigger View Webhook",
        "tags": [
          "Views"
        ]
      }
    },
    "/api/sync/wordpress/import/": {
      "post": {
        "description": "Start a WordPress \u2192 Frontbase import and return its ``import_id``.",
        "operationId": "start_import_wordpress_import__post",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/WordPressImportRequest"
              }
            }
          },
          "required": true
            ...
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "title": "Response Start Import Wordpress Import  Post",
                  "type": "object"
                }
              }
            },
        ...
        "summary": "Start a WordPress import",
        "tags": [
          "WordPress Import"
        ]
      }
    },
    "/api/sync/wordpress/import/{import_id}/": {
      "get": {
        "description": "Return the final result of a completed/failed import.\n\nCRITICAL: Validates tenant ownership. Returns 404 if the import doesn't\nexist or doesn't belong to the requesting tenant.",
        "operationId": "get_import_result_wordpress_import__import_id___get",
        "parameters": [
          {
            "in": "path",
            "name": "import_id",
          ...
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "additionalProperties": true,
                  "title": "Response Get Import Result Wordpress Import  Import Id   Get",
                  "type": "object"
                }
              }
            },
